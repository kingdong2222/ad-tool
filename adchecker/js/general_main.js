...
if (document.getElementById("close-rating-block")) {
...
if (document.getElementById("send-rating-feedback")) {
  document.getElementById("send-rating-feedback").onclick = () => {
    ...
    $.ajax({
      url:
        "https://docs.google.com/forms/d/e/1FAIpQLSfam7XB9lmQw0BsfdgDxNk9s_9FDI4YGGiODikeB53Fkf-9JQ/formResponse?",
